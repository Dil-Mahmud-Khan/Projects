...
{
    public partial class ShowEmployeeByDesignation : Form
    {
        public ShowEmployeeByDesignation()
        {
            InitializeComponent();
        }
        ...
        private void DesignationcomboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            EmployeesdataGridView.DataSource = employeeService.GetEmployeeByDesignation(DesignationcomboBox.Text);
        }
