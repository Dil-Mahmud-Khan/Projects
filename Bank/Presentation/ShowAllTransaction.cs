...
{
    public partial class ShowAllTransaction : Form
    {
        public ShowAllTransaction()
        {
            InitializeComponent();
            TransactionService transactionService = new TransactionService();
            TransactionsdataGridView.DataSource = transactionService.GetAllTransactions();
        }
        ...
        private void ShowAllTransaction_Load(object sender, EventArgs e)
        {
