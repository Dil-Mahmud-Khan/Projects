...
{
    public partial class ShowEmployeeByBranchName : Form
    {
        public ShowEmployeeByBranchName()
        {
            InitializeComponent();
        }
        ...
        private void BranchNamecomboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            EmployeesdataGridView.DataSource = employeeService.GetEmployeeByBranchName(BranchNamecomboBox.Text);
        }
        ...
        private void ShowEmployeeByBranchName_Load(object sender, EventArgs e)
        {
