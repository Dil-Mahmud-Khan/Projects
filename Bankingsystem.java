 ...
 static void createSavingsAccount(int accNum, String name, float balance, HashMap hm){
    ...
    public static void main(String[] args) {
     int x,am,o,ac,r,yr,s,accNum = 1100;
           ...
           createSavingsAccount(1099,"BankAsia\n", 100000.1f , sav);
		   
            while (true){
                try{
                System.out.println("\n Options:\n1) Create Account\n2) Change Interest Rate\n3) Add Interest \n4) Deposit Money");
                System.out.print("5) Withdraw Money\n6) Transfer Amount\n7) Show an Account Info\n8) Show All Savings Accounts Info\n");
                System.out.println("9) Show All Current Accounts Info\n10) Delete an Acoount\n11) Exit\n\n --->>>");
               Scanner input = new Scanner(System.in);
               o = input.nextInt();
                switch(o){
                    ...
                    case 8: //Show savings account info

                        for (HashMap.Entry<Integer, SavingsAccount> entry : sav.entrySet()) {
                            System.out.println( " Account Number : "+ entry.getKey() + "\n" + " Account Name : " +entry.getValue().name);
                            System.out.println();
                        }
                        break;
                    ...
                    case 9: //Show current account info

                        for (HashMap.Entry<Integer, CurrentAccount> entry : cur.entrySet()) {
                            System.out.println( " Account Number : "+ entry.getKey() + "\n" + " Account Name : " +entry.getValue().name);
                            System.out.println();
                        }
                        break;
